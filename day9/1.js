...
const codes = lib.readFileToArray("./input.txt").filter(l => l !== '').map(l => parseInt(l));
...
console.log(`Part Two: ${contiguousSetSorted[0]+contiguousSetSorted[contiguousSetSorted.length-1]}`);
